...
# 오라클 CE버전 - 8080포트가 기본이라서 포트 충돌남, 포트 변경해야됨
# server.port=8090
...
# none: 기본값. 데이터베이스 스키마에 아무런 변화를 주지 않습니다.
        ...
        # create: 애플리케이션 시작 시 기존 테이블을 삭제하고 엔티티 클래스로 새로 생성합니다. (기존 데이터 삭제)
        # create-drop: 애플리케이션 시작 시 테이블을 생성하고, 앱 종료 시 생성했던 테이블을 모두 삭제합니다. (프로젝트 중단 시 기존 데이터 삭제)
...
spring.jpa.generate-ddl=false
        ...
        # SQL 콘솔로그 2번 찍히는 것 방지 = false로 설정
...
# pretty sql format
spring.jpa.properties.hibernate.format_sql=true // 줄바꿈
spring.jpa.properties.hibernate.use_sql_comments=true // 코맨트 주석
